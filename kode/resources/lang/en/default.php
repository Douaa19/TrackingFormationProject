...
return [
    ...
    'dbsetup_note' => "Provide Your Database Credential",


    
    /** db setup */

    'dbimport_title' => "Import Database",
    'dbimport_note' => "Effortlessly enhance functionality by importing data for system optimization",
    
    'dbimport_warning' => "If your database contains data, opt for force import to remove existing tables. For an empty database, simply click 'Import.' <strong>Exercise caution  </strong>, as force import erases previous table data.",
   ...
   <li class="text-danger"><i class="ri-checkbox-circle-line"></i></i>Processing a large file will take some time</li>
