                    ...
                    <a href="{{route('user.dashboard')}}" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="{{ getImageUrl(getFilePaths()['site_logo']['path'] . "/" . site_settings('site_logo_lg')) }}"
                                alt="{{site_settings('site_logo_lg')}}" height="17">
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <button type="button" class="btn btn-icon topbar-btn btn-ghost-secondary rounded-circle"
                        @if(count($languages) != 0) data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        @endif>
                        <img id="header-lang-img"
                            src="{{asset('assets/images/global/flags/' . strtoupper($code) . '.png') }}"
                            alt="{{strtoupper($code) . '.png'}}" height="20" class="rounded">
                    </button>
                            ...
                            @foreach($languages as $language)
                                <a href="{{route('language.change', $language->code)}}"
                                    ...
                                    <img src="{{asset('assets/images/global/flags/' . strtoupper($language->code) . '.png') }}"
                                        alt="{{$language->code . ".jpg"}}" class="me-2 rounded" height="18">
                                                                                                        ...
                                                                                                        <div class="d-flex">
                                                                                                            ...
                                                                                                            <div class="flex-1">
                                                                                                                ...
                                                                                                                <div class="fs-12 text-muted">
                                                                                                                    @if(isset($data['route']))
                                                                                                                        <a id="{{$notification->id}}" data-href="{{($data['route'])}}"
                                                                                                                            href="javascript:void(0)" class="read-notification mb-1">
