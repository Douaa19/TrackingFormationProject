                        ...
                        @foreach($agents as $agent)
                                                <li class="nav-item " role="presentation">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class=" {{$unreadMessages > 0 ? "unread-msg-user" : ""  }}  nav-link agent-chat"
                                                        data-id="{{$agent->id}}" id="{{$agent->id}}">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 chat-user-img online align-self-center me-2 ms-0">
                                                                <div class="avatar-xxs">
                                                                    <img src="{{getImageUrl(getFilePaths()['profile']['admin']['path'] . "/" . $agent->image) }}"
                                                                        class="rounded-circle img-fluid userprofile" alt="{{$agent->image}}" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div
                                                                class="ms-auto unread-notifications-{{$agent->id}} {{$unreadMessages > 0 ? "" : "d-none"  }} ">
                                                                <span
                                                                    class="badge badge-soft-dark rounded p-1 unread-message-counter-{{$agent->id}}">
                                                                    @if($unreadMessages > 0)
                                                                        {{$unreadMessages}}
                                                                    @endif
                                                                </span>
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control chat-input bg-light border-light"
                                            id="chat-input" name="message" placeholder="Type your message..."
                                            autocomplete="off" />
                                    </div>
