...
@php
    ...
    foreach ($socail_login_credential as $key => $login_medium) {
        if ($login_medium['status'] == App\Enums\StatusEnum::true->status()) {
            ...
            if (in_array($medium, ['google', 'facebook'])) { // Restrict to Google and Facebook
                    ...
                    <div class="card form-wrapper card-effect">
                        <div class="card-body p-0">
                                ...
                                <form id="login-form" action="{{route('login.store')}}" method="post">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="position-relative">
                                            <input required type="email" value="{{is_demo()? 'demo@demo.com' :''}}"
                                                name="email" class="form-control pe-5" id="email"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-4">
                                            <input required type="password" name="password"
                                                value="{{is_demo() ? '123123' : ''}}"
                                                class="form-control pe-5 password-input"
                                                placeholder="{{translate("Enter password")}}" id="password-input">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @elseif(site_settings('default_recaptcha') ==
                                        App\Enums\StatusEnum::true->status())
                                        <div class="row align-items-center">
                                            <div class="col-5">
                                                <div>
                                                    <a id='genarate-captcha' class="d-flex align-items-center">
                                                        <img class="captcha-default pe-2 pointer"
                                                            src="{{ route('captcha.genarate',1) }}"
                                                            id="default-captcha">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control  p-2" required
                                                    name="default_captcha_code" value=""
                                    ...
                                    <div class="mt-4">
                                        <button type="submit"
                                            class="Btn secondary-btn btn--lg btn-icon-hover w-100 d-flex align-items-center justify-content-center"
                                            type="submit">
                                        ...
                                        <div class="mt-4 text-center">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center flex-wrap gap-3">
                                                @foreach($mediums as $medium)
                                                    <a href="{{route('social.login', $medium)}}" class="auth-btn">
                                                        <div class="auth-img"><img
                                                                src="{{asset("assets/images/" . $medium . ".png")}}" /></div>
                                                        {{ucfirst($medium)}}
                                                    </a>
                                                @endforeach
                                                @if(site_settings('authenticate_with_envato'))
                                                    <a href="{{route('social.login', 'envato')}}" class="auth-btn">
                                                        <div class="auth-img"><img
                                                                src="{{asset("assets/images/envato.png")}}" /></div>
                                                        {{ucfirst('envato')}}
                                                    </a>
                                                @endif
                                            </div>
                            ...
                            <div class="mt-4 text-center footer-text">
                                <p> {{translate("Don't have an account")}} ? <a href="{{route("register")}}"
