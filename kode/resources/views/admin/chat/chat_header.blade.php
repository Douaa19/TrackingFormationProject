        ...
        <div class="col-sm-6">
            <ul class="list-inline user-chat-nav text-end mb-0">
                @if(count($chat_messages) != 0)
                    <li
                        class="list-inline-item m-0"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top"
                ...
                @endif
                    ...
                    <li
                        class="list-inline-item ms-2"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top"
                        title="Block">
                ...
                @if(!$anonymous)
                    ...
                    <li
                        class="list-inline-item"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top"
                ...
                @if($anonymous)
                    ...
                    <li class="list-inline-item d-none d-lg-inline-block m-0 dropdown"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            @foreach($agents as $agent)
                                <button data-anonymous = "{{$anonymous}}" value="{{ $agent->id}}"  name="assign" id="assignBtn" class="dropdown-item" >
