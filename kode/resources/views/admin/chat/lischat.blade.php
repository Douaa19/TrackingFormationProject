		...
		<div class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table id="participant-table" class="w-100 table table-bordered dt-responsive nowrap table-striped align-middle">
						<thead>
							<tr>
								<th></th>
							...
							@foreach($participants as $participant)
								<tr>
                                    ...
                                    @php
                                            ...
                                            @endphp
										<img src="{{ $imageUrl }}" alt="{{ $user->name }}" class="avatar-xs rounded-circle me-2">
                                    </td>
