                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="serial_id" id="serial_id" class="form-control"  placeholder="{{translate("Enter Serial Id")}}"
                                    value="{{$article->serial_id }}" required>
                                ...
                                <select class="form-select" required name="category_id" id="category_id">
                                     <option value="">
                                        ...
                                        @foreach($items as $item)
                                          ...
                                          <option {{$article->category_id  == $item->id ? "selected" :"" }} value="{{$item->id}}">
                                ...
                                <select class="form-select" required name="article_category_id" id="article_category_id">
                                     <option value="">
                                        ...
                                        @foreach($categories as $category)
                                          ...
                                          <option {{$article->article_category_id == $category->id ? "selected" :"" }} value="{{$category->id}}">
                                            {{($category->name)}}
                                          </option>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="text-editor-area">
                                    ...
                                    <textarea placeholder="{{translate("Type Here .....")}}" class="form-control summernote" name="description" id="text-editor" cols="30" rows="10">{{$article->description}}</textarea>
