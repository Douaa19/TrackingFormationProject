                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div >
                                ...
                                <input required type="text" name="phone" value="{{old('phone')}}" class="form-control" placeholder="{{translate("Enter Phone Number")}}" id="Phone">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div >
                                ...
                                <input required  type="text" name="username" value="{{old('username')}}" class="form-control" placeholder="{{translate("Enter Username")}}" id="username">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <input data-size ="{{getFilePaths()['profile']['admin']['size']}}" type="file" class="preview form-control w-100"
                                ...
                                <label  class="form-label">
                                    ...
                                    @foreach(agent_permissions() as $permission)
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" name="permissions[]" value="{{$permission}}" type="checkbox" id="{{$loop->index}}" >
