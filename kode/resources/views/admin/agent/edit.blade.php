                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <select name="type" id="type" class="form-select">
                                ...
                                <option {{ $agent->super_agent == 2 ? 'selected' : ''}} value="1">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input required type="text" name="name" value="{{$agent->name}}" class="form-control"
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input required type="email" name="email" value="{{$agent->email}}" class="form-control"
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input required type="text" name="phone" value="{{$agent->phone}}" class="form-control"
                                placeholder="{{translate('Enter Your Phone')}}" id="Phone">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input required type="text" name="username" value="{{$agent->username}}"
                                class="form-control" placeholder="{{translate("Enter Username")}}" id="username">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input id="formFile" data-size="{{getFilePaths()['profile']['admin']['size']}}" type="file"
                                class="preview form-control w-100" name="image">
                        </div>
                        ...
                        <div class="d-flex flex-row flex-wrap permission-wrapper">
                            ...
                            @foreach(agent_permissions() as $permission)
                                                    <div class="form-check mb-3">
                                                        <input {{in_array($permission, $accessPermissions) ? 'checked' : ""}}
                                                            class="form-check-input" name="permissions[]" value="{{$permission}}"
