            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-sm-auto">
                    <div class="d-flex flex-wrap align-items-start gap-2">
                        <a href="{{route('admin.user.create')}}" class="btn btn-success add-btn waves ripple-light"><i
...
<div class="modal fade" id="updatePassword" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg scorllable-modal">
        <div class="modal-content">
            ...
            <form action="{{route('admin.user.password.update')}}" id="modalForm" method="post"
...
<!-- Assign User Modal -->
<div class="modal fade modal-custom-bg" id="assignUserModal" tabindex="-1" aria-labelledby="assignUserModal"
    aria-hidden="true">
