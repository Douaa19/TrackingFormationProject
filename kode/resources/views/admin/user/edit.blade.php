                    ...
                    <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="mt-3">
                            <div>
                                ...
                                <input id="formFile" data-size="{{getFilePaths()['profile']['user']['size']}}"
                                    type="file" class="preview form-control w-100" name="image">
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            <div>
                                ...
                                <input value="{{$user->phone}}" type="text" class=" form-control w-100" name="phone"
                                    id="phone">
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            <div>
                                ...
                                <input value="{{$user->cnss}}" type="text" class=" form-control w-100" name="cnss"
                                    id="cnss">
                            </div>
                        </div>
                        ...
                        @if(site_settings('geo_location') == 'map_base' && site_settings('auto_ticket_assignment') == App\Enums\StatusEnum::true->status())
                                                <div class="col-xl-12 col-lg-12">
                                                    ...
                                                    <input type="text" id="address-input" name="address" value="{{ $address_val}}"
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="mt-3">
                            <div>
                                ...
                                <input required type="text" name="garage_name" value="{{$user->garage_name}}"
                        ...
                        <div class="mt-3">
                            <div>
                                ...
                                <input required type="text" name="revenue"
                                    value="{{$user->revenue ? $user->revenue : 0}}" class="form-control" id="Revenue">
                            </div>
                        </div>
                        ...
                        {{-- <div class="mt-3">
                            <div>
                                ...
                                <select required class="form-select" name="traning_type" id="traning_type">
                                    <option value="direct_training_(CSF)" {{ $user->training_type ==
                                        'direct_training_(CSF)' ? 'selected' : '' }}>
                                        {{ translate('Direct Training') }} (CSF)
                                    </option>
                                    <option value="engineering_training_(GIAC+CSF)" {{ $user->training_type ==
                                        'engineering_training_(GIAC+CSF)' ? 'selected' : '' }}>
                        ...
                        <div class="mt-3">
                            <div>
                                ...
                                <select required class="form-select" name="traning" id="tranings">
                                    ...
                                    <option value="diagnosis_training" {{ $user->training == 'diagnosis_training' ?
                                        'selected' : '' }}>
                                    ...
                                    <option
                                        value="preparation_for_the_electrical_activation_of_ev_charging_infrastructures"
                                        {{ $user->training ==
                                        'preparation_for_the_electrical_activation_of_ev_charging_infrastructures' ?
                                        'selected' : '' }}>
                                        {{ translate('Preparation for the electrical activation of EV charging
                                        infrastructures') }}
                                    </option>
                                    <option value="preparation_for_VE/VH_electrical_clearance" {{ $user->training ==
                                        'preparation_for_VE/VH_electrical_clearance' ? 'selected' : '' }}>
