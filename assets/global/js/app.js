!(function () {
                ...
                (e < 1025 && 767 < e
                    ...
                    : 1025 <= e
                        ...
                        (document.body.classList.remove("vertical-sidebar-enable"),
                            ...
                            "twocolumn" == sessionStorage.getItem("data-layout-default") &&
                            (document.documentElement.setAttribute("data-layout-default", "vertical"),
                                k("vertical"),
                                f()),
    ...
    function M() {
        ...
        767 < e &&
            ...
            "vertical" === document.documentElement.getAttribute("data-layout-default") &&
            (e < 1025 && 767 < e
                ? (document.body.classList.remove("vertical-sidebar-enable"),
    ...
    function O() {
        ...
        window.addEventListener("load", function () {
            var e;
            ("twocolumn" == document.documentElement.getAttribute("data-layout-default")
                ? A
                : L)(),
    ...
    function L() {
        ...
        (e = e.substring(e.lastIndexOf("/") + 1)) && (e = document
            .getElementById("navbar-nav")
            ...
            (e.parentElement.parentElement.parentElement.parentElement
                .closest(".collapse")
                .previousElementSibling.classList.add("active"),
                "horizontal" == document.documentElement.getAttribute("data-layout-default")) &&
...
wavesEffect && (wavesEffect.forEach((wavesEffect) => {
    let timerId;
...
function showSidebar() {
    var sidebar = document.querySelector('.ticket-sidebar');
    if (sidebar) {
...
function createOverlay() {
    ...
    overlay.setAttribute("id", "email-wrapper-overlay");
...
function removeOverlay() {
    const emailOverlay = document.querySelector("#email-wrapper-overlay")
    emailOverlay && emailOverlay.remove()
}

var sidebarButton = document.querySelector('#ticket-menu-btn');
